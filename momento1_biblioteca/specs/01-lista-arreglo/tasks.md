...
| T2 | Escribir test_lista_arreglo.py con la bateria completa, en rojo | CA-01 a CA-22 | Si |
| T3 | Escribir prediccion.md con la complejidad derivada, antes de medir | -- | Si |
